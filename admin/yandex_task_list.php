...
$sTableId = "yandex_yandex_turbo_task";
...
{
	$arActions = array();
	$el_edit_url = htmlspecialcharsbx(\Yandex\TurboAPI\CYandexTurboAPITools::GetAdminElementEditLink($arRes["ID"], 'yandex_task_edit.php?ID='));
	...
	$arActions[] = array("ICON" => "edit", "TEXT" => Loc::getMessage("YANDEX_TYRBO_API_OPEN"), "ACTION" => $lAdmin->ActionRedirect($el_edit_url), "DEFAULT" => true,);
	if($POST_RIGHT >= "W")
...
$oFilter = new CAdminFilter(
	...
	array(
		...
		Loc::getMessage("YANDEX_TYRBO_API_FILTER_FEED_ID"),
		Loc::getMessage("YANDEX_TYRBO_API_FILTER_LID"),
		Loc::getMessage("YANDEX_TYRBO_API_FILTER_MODE"),
	)
);
...
<tr>
	<td><?=Loc::getMessage("YANDEX_TYRBO_API_FILTER_FEED_ID")?>:</td>
	<td>
		<input type="text" name="filter_feed_id" value="<?=htmlspecialcharsbx($filter_feed_id)?>">
	</td>
</tr>
<tr>
	<td><?=Loc::getMessage("YANDEX_TYRBO_API_FILTER_LID")?>:</td>
	<td>
		<?\Yandex\TurboAPI\CYandexTurboAPITools::ShowLidField('filter_lid', false, true);?>
	</td>
</tr>
<tr>
	<td><?=Loc::getMessage("YANDEX_TYRBO_API_FILTER_MODE")?>:</td>
	<td>
		<select name="filter_mode">
			<option value=""><?=Loc::getMessage("YANDEX_TYRBO_API_ALL")?></option>
			<option value="DEBUG"<?if ($filter_mode=="DEBUG") echo " selected"?>><?=Loc::getMessage("YANDEX_TYRBO_API_DEBUG")?></option>
			<option value="PRODUCTION"<?if ($filter_mode=="PRODUCTION") echo " selected"?>><?=Loc::getMessage("YANDEX_TYRBO_API_PRODUCTION")?></option>
		</select>
	</td>
</tr>
<?
