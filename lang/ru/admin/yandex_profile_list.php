...
$MESS['YANDEX_TYRBO_API_ADMIN_TITLE'] = 'Список профилей';
$MESS['YANDEX_TYRBO_API_DELETE'] = 'Удалить';
$MESS['YANDEX_TYRBO_API_EDIT'] = 'Изменить';
$MESS['YANDEX_TYRBO_API_COPY_PROFILE'] = 'Копировать';
...
$MESS['YANDEX_TYRBO_API_ADD'] = 'Добавить профиль';
...
$MESS["YANDEX_TYRBO_API_NOTES13_EXT"] = "Если по указанному пути <b>cron_frame_xml.php</b> отсутствует, необходимо скопировать его из папки <b>#FOLDER#</b> (путь указан от корня сайта).";
