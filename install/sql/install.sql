create table if not exists yandex_yandex_turbo_feed (
	...
	INDEX yandex_yandex_turbo_feed(IBLOCK_ID),
	primary key (ID)
)
ENGINE = InnoDB;

create table if not exists yandex_yandex_turbo_task (
	ID int(11) not null auto_increment,
	...
	primary key (ID),
	INDEX yandex_yandex_turbo_task(FEED_ID)
)
ENGINE = InnoDB;

create table if not exists yandex_yandex_turbo_profile (
	ID int(11) not null auto_increment,
	...
	INDEX yandex_yandex_turbo_profile(IBLOCK_ID),
	primary key (ID)
)
ENGINE = InnoDB;