...
<item turbo="<?=$arField['ITEM']?>">			
	...
	<![CDATA[
		...
		<p>&nbsp;</p>
		<?=\Yandex\TurboAPI\Turbo::getStrContentFields($arField['TURBO_CONTENT_FIELDS'])?>
		<p>&nbsp;</p>
		<?
		if($arField['DISPLAY_PROPERTIES'])
		{
			echo \Yandex\TurboAPI\Turbo::getStrProrertyValue($arField['DISPLAY_PROPERTIES']);
		}
		?>
		<p>&nbsp;</p>
		<?
		if($turboContentFields = \Yandex\TurboAPI\Turbo::getStrAccordionFields($arField['TURBO_CONTENT_FIELDS']))
		{
			?>
