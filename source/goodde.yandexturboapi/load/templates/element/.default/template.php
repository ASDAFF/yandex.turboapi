...
<item turbo="<?=$arField['ITEM']?>">			
	...
	<![CDATA[
		...
		<p>&nbsp;</p>
		<?=\Goodde\YandexTurbo\Turbo::getStrContentFields($arField['TURBO_CONTENT_FIELDS'])?>
		<p>&nbsp;</p>
		<?
		...
		<p>&nbsp;</p>
		<?
		if($turboContentFields = \Goodde\YandexTurbo\Turbo::getStrAccordionFields($arField['TURBO_CONTENT_FIELDS']))
		{
			?>
