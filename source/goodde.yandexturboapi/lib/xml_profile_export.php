...
class ProfileExport extends \Goodde\YandexTurbo\TurboFeed
{
	...
	public function __construct($element = 0, $parameters = array())
	{
		...
		$this->content = '';
		$this->arTypes = \Goodde\YandexTurbo\CGooddeYandexTurboTools::getOfferType($this->feed['TYPE']);
    }
	...
	public function loadFeed()
    {
		...
		if (!Loader::includeModule('iblock')) {
			...
			$APPLICATION->ThrowException(Loc::getMessage("GOODDE_TYRBO_API_ERROR_IBLOCK"));
			return false;
		}
	...
	{
		/*bind events*/
		foreach(GetModuleEvents("goodde.yandexturboapi", "OnBeforeXmlProfileExport", true) as $arEvent)
		{
	...
	protected function setBaseSelect()
	{
		...
		if(!\Goodde\YandexTurbo\ModuleVersion::isIblockNewCatalog18())
		{
	...
	public function getItemsFilter()
    {
		...
		if(array_key_exists('AVAILABLE', $elementsFilter) && !\Goodde\YandexTurbo\ModuleVersion::isIblockNewCatalog18())
		{
		...
		/*bind events*/
		foreach(GetModuleEvents("goodde.yandexturboapi", "OnXmlProfileOneStepElementFilterBefore", true) as $arEvent)
		{
	...
	protected function getoffersFilter()
	{
		...
		if(array_key_exists('AVAILABLE', $offersFilter) && !\Goodde\YandexTurbo\ModuleVersion::isIblockNewCatalog18())
		{
	...
	protected function getCategories()
	{
		...
		\Goodde\Export\TurboProfileTable::update(
			 $this->feed['ID'],
