...
$MESS['YA_ZEN'] = array(
	 ...
	 "FIELDS"      => array(
			"guid"            => array(
				 ...
				 "VALUE"        => array("ID"),
				 "USE_FUNCTION" => "Y",
				 "FUNCTION"     => "\Goodde\Export\ProfileTools::getGuid",
			),
			"title"           => array(
				 "CODE"     => "title",
    ...
    «nonadult» — контент, который можно показывать взрослым и детям от 13 лет.",
			...
			"description"     => array(
				 ...
				 "USE_FUNCTION" => "Y",
				 "FUNCTION"     => "\Goodde\Export\ProfileTools::getPreviewText",
			),
			"content:encoded" => array(
				 ...
				 "USE_FUNCTION" => "Y",
				 "FUNCTION"     => "\Goodde\Export\ProfileTools::getDetailText",
			),
