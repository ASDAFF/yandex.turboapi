...
class FeedTable extends Entity\DataManager
{
	...
	{
		return 'goodde_yandex_turbo_feed';
	}
	...
	public static function getMap()
	{
		return array(
			...
			'IBLOCK_ID' => array(
				'data_type' => 'integer',
				'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_IBLOCK_ID_FIELD'),
				'validation' => array(__CLASS__, 'validateIblockId'),
			),
			'TIMESTAMP_X' => array(
				'data_type' => 'datetime',
				'default_value' => new Type\DateTime(),
				'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_TIMESTAMP_X_FIELD'),
			),
			'MODIFIED_BY' => array(
				'data_type' => 'integer',
				'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_MODIFIED_BY_FIELD'),
			),
			'DATE_CREATE' => array(
				'data_type' => 'datetime',
				'default_value' => new Type\DateTime(),
			...
			'CREATED_BY' => array(
				'data_type' => 'integer',
				'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_CREATED_BY_FIELD'),
			),
			'ACTIVE' => array(
				'data_type' => 'boolean',
				'default' => self::LEFT_TO_RIGHT, 
				'values' => array(self::RIGHT_TO_LEFT, self::LEFT_TO_RIGHT),
				'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_ACTIVE_FIELD'),
				'editable' => true,
			),
			'LID' => array(
				'data_type' => 'string',
			...
			'DETAIL_URL' => array(
				'data_type' => 'string',
				'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_DETAIL_URL_FIELD'),
			...
			'PRICE_CODE' => array(
				'data_type' => 'string',
				'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_PRICE_CODE_FIELD'),
			...
			'SERVER_ADDRESS' => array(
                'data_type' => 'string',
                'required' => true,
				'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_SERVER_ADDRESS_FIELD'),
                'validation' => array(__CLASS__, 'validateServerAddress'),
				'editable' => true,
            ),
			'DESCRIPTION' => array(
				'data_type' => 'text',
				'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_DESCRIPTION_FIELD'),
				'editable' => true,
				'hidden' => true,
			),
			'FIGCAPTION_VIDEO' => array(
				'data_type' => 'string',
				'required' => true,
				'title' => Loc::getMessage('GOODDE_TYRBO_API_FIGCAPTION_VIDEO_FIELD'),
			...
			'SORT' => array(
				'data_type' => 'integer',
				'default' => '500', 
				'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_SORT_FIELD'),
			...
			'TEMPLATE' => array(
                ...
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_TEMPLATE_FIELD'),
				'editable' => true,
				'hidden' => true
            ),
			'ITEM_STATUS' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_ITEM_STATUS_FIELD'),
				'editable' => true,
				'hidden' => true
            ),
			'IPROPERTY_TEMPLATES' => array(
                'data_type' => 'string',
				'serialized' => true,
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_IPROPERTY_TEMPLATES_FIELD'),
				'editable' => true,
				'hidden' => true
            ),
			'ALL_FEED' => array(
				...
				'values' => array(self::RIGHT_TO_LEFT, self::LEFT_TO_RIGHT),
				'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_ALL_FEED_FIELD'),
				'editable' => true,
				'hidden' => true
			),
			'LIMIT' => array(
                'data_type' => 'integer',
				'default' => '1000',
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_LIMIT_FIELD'), 
				'editable' => true,
				'hidden' => true
            ),
            'ACTIVE_DATE' => array(
                'data_type' => 'boolean',
                'values' => array(self::RIGHT_TO_LEFT, self::LEFT_TO_RIGHT),
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_ACTIVE_DATE_FIELD'),
            ...
            'MENU' => array(
                'data_type' => 'string',
				'serialized' => true,
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_MENU_FIELD'),
				'editable' => true,
				'hidden' => true
            ),
            'FORM' => array(
                ...
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_FORM_FIELD'),
				'editable' => true,
				'hidden' => true
            ),
			'FEEDBACK' => array(
                'data_type' => 'string',
				'serialized' => true,
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_FEEDBACK_FIELD'),
				'editable' => true,
				'hidden' => true
            ),
            'CONTENT' => array(
                ...
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_CONTENT_FIELD'),
				'editable' => true,
				'hidden' => true
            ),
            'PUB_DATE' => array(
                ...
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_PUB_DATE_FIELD'),
				'editable' => true,
				'hidden' => true
            ),
            'GALLERY' => array(
                ...
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_GALLERY_FIELD'),
				'editable' => true,
				'hidden' => true
            ),
			'IS_SECTION' => array(
			...
			'SECTIONS_ID' => array(
                'data_type' => 'string',
				'serialized' => true,
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_SECTIONS_ID_FIELD'),
				'editable' => true,
				'hidden' => true
            ),
			'FIELDS' => array(
                'data_type' => 'string',
				'serialized' => true,
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_FIELDS_FIELD'),
				'editable' => true,
				'hidden' => true
            ),
			'SECTION_URL' => array(
			...
			'PROPERTY' => array(
                'data_type' => 'string',
				'serialized' => true,
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_PROPERTY_FIELD'),
				'editable' => true,
				'hidden' => true
            ),
			'OFFERS_PROPERTY' => array(
                'data_type' => 'string',
				'serialized' => true,
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_OFFERS_PROPERTY_FIELD'),
				'editable' => true,
				'hidden' => true
            ),
            'RELATED_LIMIT' => array(
                'data_type' => 'integer',
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_RELATED_LIMIT_FIELD'),
				'default' => '4', 
				'editable' => true,
				'hidden' => true
            ),
            'RELATED_SOURCE' => array(
                ...
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_RELATED_SOURCE_FIELD'),
				'editable' => true,
				'hidden' => true
            ),			
            'SHARE_NETWORKS' => array(
                ...
                'serialized' => true,
                'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_SHARE_NETWORKS_FIELD'),
				'editable' => true,
				'hidden' => true
            ),
			'DATE_ADD_FEED' => array(
			...
			'IN_AGENT' => array(
				'data_type' => 'boolean',
				'default' => self::RIGHT_TO_LEFT,
				 'title' => Loc::getMessage('GOODDE_TYRBO_API_ENTITY_IN_AGENT_FIELD'),
				'values' => array(self::RIGHT_TO_LEFT, self::LEFT_TO_RIGHT)
			),
		);
	}
	...
	public static function onAfterAdd(\Bitrix\Main\Entity\Event $event)
    {
        ...
        if(intval($feed['ID']) > 0)
			\Bitrix\Main\IO\Directory::createDirectory(\Goodde\YandexTurbo\Turbo::getPath().'/'.$feed['ID'].'/');
    }
	...
	public static function OnBeforeDelete(\Bitrix\Main\Entity\Event $event)
    {
        ...
        if(intval($feed['ID']) > 0)
		{
			$arFeed = \Goodde\YandexTurbo\FeedTable::getById($feed['ID'])->fetch();
	...
	public static function onAfterDelete(\Bitrix\Main\Entity\Event $event)
    {
        ...
        if(intval($feed['ID']) > 0)
		{
			\Bitrix\Main\IO\Directory::deleteDirectory(\Goodde\YandexTurbo\Turbo::getPath().'/'.$feed['ID'].'/');
		}
    }
