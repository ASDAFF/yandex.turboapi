<?
$MESS['YM_VENDOR_MODEL'] = array(
	 "CODE"                => "ym_vendor_model",
	 "GROUP"               => "Яндекс.Маркет",
	 "SORT"                => 15,
	 "NAME"                => "Произвольный тип описания (vendor.model)",
	 "DESCRIPTION"         => "Элементы &lt;typePrefix&gt; &lt;vendor&gt; &lt;model&gt; формируют название предложения на Маркете и влияют на привязку к карточке модели. 
<a href=\"https://yandex.ru/support/partnermarket/export/vendor-model.html\" target=\"_blank\">Подробнее...</a>",
	 ...
	 "FIELDS"              => array(
			...
			"typePrefix" => array(
				 "CODE" => "typePrefix",
				 "NAME" => "<b>Тип / категория товара</b><br>Например: планшет, мобильный телефон, стиральная машина, угловой диван и т.п.<br>Существенно влияет на размещение товара в правильной категории и привязку к карточке товара",
			),
			"cbid"       => array(
				 "CODE" => "cbid",
			...
			"store"                 => array(
				 "CODE" => "store",
				 "NAME" => "<b>Возможность купить товар в розничном магазине</b><br><code>true</code> — товар можно купить в розничных магазинах.<code><br>false</code> — возможность покупки в розничных магазинах отсутствует;",
			),
			"outlets"               => array(
				 "CODE" => "outlets",
...
<offers>',
	 ...
	 "XML_OFFER"           => '<offer id="#id#" type="vendor.model" available="#available#" bid="#bid#" cbid="#cbid#" fee="#fee#" group_id="#group_id#">
    <url>#url#</url>
    <price>#price#</price>
